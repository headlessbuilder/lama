...
const Email = ({ firstName, loginLink }: Props) => {
  const previewText = firstName ? `Welcome to llm.report, ${firstName}!` : `Welcome to llm.report!`;

  return (
    <Html>
      <Head>
        <Font fontFamily="sans-serif" fallbackFontFamily="Arial" fontWeight={400} fontStyle="normal" />
      </Head>
