...
export const IMAGE_RESOLUTIONS: ImageResolution[] = ['256x256', '512x512', '1024x1024'];
...
export const CHAT_MODELS: ChatCompletionModel[] = [...CHAT_GPT3_MODELS, ...CHAT_GPT4_MODELS];
...
export const EDIT_MODELS: EditModel[] = ['text-davinci-edit-001', 'code-davinci-edit-001'];
...
export const COLORS: Color[] = ['blue', 'purple', 'amber', 'rose', 'indigo', 'emerald', 'sky', 'lime', 'pink'];
