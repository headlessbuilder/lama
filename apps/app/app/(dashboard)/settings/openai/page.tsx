...
const OpenAISettings = () => {
  ...
  return (
    <>
      <Callout className="my-4" title="Advanced Security" icon={LockIcon} color="blue">
        API key is stored in your browser&apos;s local storage only. It is not sent to any server.
      </Callout>
        ...
        >
          <div>
            <div className="flex flex-row">
              <label className="font-medium text-gray-500">OpenAI Session Token</label>
      ...
      >
        ...
        <form onSubmit={(e) => e.preventDefault()} className="mt-8">
          <div>
            <div className="flex flex-row">
              <label className="font-medium text-gray-500">OpenAI Organization ID</label>
            </div>
            <input
              type="text"
