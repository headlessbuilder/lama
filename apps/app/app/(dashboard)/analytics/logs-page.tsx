...
export default function LogsPage({ code }: { code: any }) {
  ...
  return (
    <Suspense>
      {!isLoading && logCount < 1 && <LogsOnboarding code={code} onRefresh={refetch} />}
          ...
          <Col numColSpan={1}>
            <Card className="shadow-none">
              <CardHeader>
                ...
                <CardDescription>Analyze your logs and see how your prompts are performing.</CardDescription>
              </CardHeader>
              <CardContent>
