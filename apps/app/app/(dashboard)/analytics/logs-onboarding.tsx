...
const LogsOnboarding = ({ code, className, onRefresh = () => {}, user_id = false }: OnboardingProps) => {
        ...
        <Grid numItems={1} className="gap-4 w-full">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Building an AI product is hard. You probably wrote your prompt template once and then never changed it
                hoping for the best 😅. You also may not know how many times your AI model hallucinates, fails, or gives
                your users a terrible and unrelated answer.
              </CardDescription>
              <CardDescription className="font-semibold">
                Let&apos;s help you log your requests and improve your product experience!
              </CardDescription>
            </CardHeader>
            <CardContent>
              <video src="https://cdn.llm.report/openai-demo.mp4" autoPlay loop muted className="rounded-xl border" />
            </CardContent>
          </Card>
          <Card>
