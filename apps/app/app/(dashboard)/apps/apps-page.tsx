...
import { Col, DateRangePicker, DateRangePickerItem, DateRangePickerValue, Grid } from '@tremor/react';
import { add, endOfDay, format, startOfDay, startOfMonth, startOfYear, sub } from 'date-fns';
    ...
    <Suspense>
      ...
      {!loading && userCount >= 1 && (
        <Grid numItems={1} numItemsLg={1} className="gap-6 w-full">
          ...
          <Col numColSpan={1}>
            <DateRangePicker value={value} onValueChange={setValue} selectPlaceholder="Select">
          ...
          <Col numColSpan={1}>
            <Card className="shadow-none">
              <CardHeader>
                ...
                <CardDescription>
                  The total cost of the top 10 apps from {value.from && format(value.from, 'yyyy-MM-dd')} to{' '}
          ...
          <Col numColSpan={1}>
            <Card className="shadow-none">
              <CardHeader>
                ...
                <CardDescription>A usage summary of the top apps</CardDescription>
              </CardHeader>
              <CardContent>
                <Suspense fallback={<>loading...</>}>
