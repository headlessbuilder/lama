...
const Step = ({ className, ...props }: React.ComponentProps<'h3'>) => (
  <div className={cn('font-heading mt-6 scroll-m-20 text-xl font-semibold tracking-tight', className)} {...props} />
);

const Steps = ({ ...props }) => (
  <div className="[&>div]:step mb-8 ml-4 border-l pl-8 [counter-reset:step]" {...props} />
);
...
export const InstallSteps = () => {
  return (
    <Steps>
      <Step>
        Go to{' '}
        <a className="underline text-blue-500" target="_blank" href="https://platform.openai.com/account/usage">
      ...
      <div className="grid grid-cols-2 gap-4 items-center">
        <div className="flex flex-col justify-center items-center">
          ...
          <pre className="my-2 text-center">
            <code className="bg-gray-100 p-2 rounded-md text-sm">cmd + option + i</code>
          </pre>
          <br></br>
          <p className="text-center">Windows:</p>
          <pre className="my-2 text-center">
            <code className="bg-gray-100 p-2 rounded-md text-sm">ctrl + shift + i</code>
          </pre>
        </div>
        <div className="flex justify-center items-center">
          <img src="https://cdn.llm.report/onboarding-inst-0.png" alt="Instructions" style={{ maxWidth: '15vw' }} />
        </div>
      </div>
      <Step>Click the Network Tab</Step>
      <img src="https://cdn.llm.report/onboarding-inst-1.png" alt="Instructions" />
      <Step>Click the Search Icon beside</Step>
      <img src="https://cdn.llm.report/onboarding-inst-2.png" alt="Instructions" />
      <Step className="text-red-500">Refresh Your Screen While On Network Tab</Step>
      <Step>Search &apos;sess&apos; and click green highlight</Step>
      <img src="https://cdn.llm.report/onboarding-inst-03.png" alt="Instructions" />
      <Step>Scroll and copy the session from the right side</Step>
      <img src="https://cdn.llm.report/onboarding-inst-04.png" alt="Instructions" />
      <Step>Paste the session token below</Step>
      <p>Only paste the token itself, remove the `Bearer` prefix</p>
      <pre className="my-2">
        <code className="bg-gray-100 p-2 rounded-md text-sm">sess-rYyW10fURtEce3rYSS6QGRMnLziKwrRdZeDt</code>
      </pre>
    </Steps>
  );
};
...
const OnboardingDashboard = ({ className }: { className?: string }) => {
  ...
  return (
    <Suspense>
      <div className={cn('flex flex-col w-full max-w-3xl space-y-4', className)}>
        <Grid numItems={1} className="gap-4 w-full">
          <Card>
            <CardHeader>
              ...
              <CardDescription className="text-xl">Instructional Video Below</CardDescription>
            </CardHeader>
            <CardContent>
              <video
          ...
          <Card>
            <CardHeader className="flex-row gap-4 items-center">
              <CardTitle className="flex gap-2 flex-row items-center">Token:</CardTitle>
              <Input
                type="text"
          ...
          <Card>
            ...
            <CardHeader className="flex-row gap-4 items-center">
              ...
              <div className="flex flex-col justify-center gap-1.5">
                ...
                <CardDescription>
                  Paste your OpenAI session token below to get started. We use your OpenAI session token to call the
                  OpenAI API and create your dashboard. This does not cost you and we do not store your key on our
                  servers.
                </CardDescription>
              </div>
            </CardHeader>
