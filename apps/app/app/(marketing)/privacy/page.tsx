...
const Privacy = () => {
  return (
    <div className="prose container flex flex-col justify-center max-w-10xl pb-16 px-8">
      <h1 className="tracking-wide font-semibold flex m-auto text-5xl text-left pt-12 text-gray-950">Privacy Policy</h1>

      <p>llm.report operates the https://llm.report website, which provides monitoring and reporting services.</p>

      <p>
        This page is used to inform website visitors regarding our policies with the collection, use, and disclosure of
        Personal Information if anyone decided to use our Service, the llm.report website.
      </p>
      ...
      <p>
        ...
        at https://llm.report, unless otherwise defined in this Privacy Policy.
      </p>
