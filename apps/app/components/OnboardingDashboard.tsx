...
const Steps = ({ ...props }) => (
  <div className="[&>div]:step mb-12 ml-4 border-l pl-8 [counter-reset:step]" {...props} />
);
...
export const InstallSteps = () => {
  return (
    <Steps>
      ...
      <pre className="my-2">
        <code className="bg-gray-100 p-2 rounded-md text-sm">https://api.openai.com/dashboard/billing/usage</code>
      </pre>
      <Step>Copy session token</Step>
      <p>It will be in the request headers under `authorization`</p>
      <p>It looks like this:</p>
      <pre className="my-2">
        <code className="bg-gray-100 p-2 rounded-md text-sm">Bearer sess-rYyW10fURtEce3rYSS6QGRMnLziKwrRdZeDt</code>
      </pre>
    ...
    <div className={cn('flex flex-col w-full max-w-xl space-y-4', className)}>
      <Grid numItems={1} className="gap-4 w-full">
        <Card>
          ...
          <Text>
            We use your OpenAI session token to call the OpenAI API and create your dashboard. This does not cost you
            and we do not store your key on our servers.
          </Text>
