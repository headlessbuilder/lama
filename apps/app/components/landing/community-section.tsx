    ...
    <section id="community">
      <div className="max-w-screen-xl mx-auto px-4 md:text-center md:px-8 py-20">
        <div className="max-w-xl space-y-3 md:mx-auto">
          ...
          <p className="text-gray-800 text-3xl font-semibold sm:text-4xl">Join our community</p>
          <p className="text-gray-600">Join our open-source community and help shape the future of LLM Report.</p>
        </div>
        <div className="mt-4 flex gap-4 justify-center items-center">
          ...
          <Link href="/discord" className={cn(buttonVariants({ size: 'lg', variant: 'outline' }), 'gap-2')}>
