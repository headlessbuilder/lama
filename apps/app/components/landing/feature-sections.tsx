...
const features = [
  ...
  },
  {
    ...
    description: 'Analyze your cost per user and adjust your pricing to maximize revenue.',
    icon: Icons.user,
          ...
          <div className="mx-auto px-6 py-6 sm:py-20">
            <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-16 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-5">
              <div
                ...
                <h2 className="text-base font-semibold leading-7 text-orange-600">{feature.header}</h2>
