  ...
  <div className="mt-12 flex flex-col gap-4 justify-center items-center">
    ...
    <div className="flex flex-row gap-4">
      <Link
        ...
        <img src="/accelerator-badge-dark.png" alt="Backed by Vercel AI Accelerator" className="w-36" />
      </Link>
      ...
      <Link
        ...
        <img src="/buildspace-badge-dark.png" alt="Backed by Buildspace" className="w-36" />
      </Link>
    </div>
  </div>
);
