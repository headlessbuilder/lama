      ...
      <div className="py-14 space-y-14">
        <div className="mx-auto max-w-md text-center sm:max-w-2xl">
          <h2 className="font-display text-4xl font-bold leading-tight text-black sm:text-5xl sm:leading-tight">
            ...
            and{' '}
            <span className="bg-gradient-to-r from-red-600 to-amber-600 bg-clip-text text-transparent">companies</span>{' '}
            worldwide
          </h2>

          <p className="mt-5 text-gray-600 sm:text-lg">Here&apos;s what our users have to say</p>
        </div>

        <div className="flex gap-4 flex-col">
          <Marquee pauseOnHover className="[--duration:40s]">
            {firstRow?.map((t, idx) => (
              <ServerTweetCard tweet={t} key={idx} className="h-full w-72 min-w-[22rem]" />
            ))}
          </Marquee>
