...
const Onboarding = ({ code, className, onRefresh, user_id = false }: OnboardingProps) => {
        ...
        <Grid numItems={1} className="gap-4 w-full">
          <Card>
            <CardHeader>
              ...
              <CardDescription className="font-semibold">Lets start answering your questions today.</CardDescription>
            </CardHeader>
            <CardContent>
              <video src="/users-demo.mp4" autoPlay loop muted className="rounded-xl border" />
            </CardContent>
          </Card>
          <Card>
          ...
          <Card
            ...
            <CardContent>
              <Select
                ...
                <SelectTrigger>
                  <SelectValue defaultValue="developer" placeholder="Developer - $20/month" />
                </SelectTrigger>
                <SelectContent>
                  {/* <SelectItem value="free">Free - $0/month</SelectItem> */}
                  <SelectItem value="developer">Developer - $20/month</SelectItem>
