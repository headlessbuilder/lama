...
const MonthlyChartByMinute = ({ startDate, endDate, categories }: MonthlyChartProps) => {
  const { snapshots, selectedSnapshots, data: costChartData } = useCostChartData(startDate, endDate, categories);

  if (!snapshots || !selectedSnapshots || !costChartData) return <MonthlyChartLoading />;
