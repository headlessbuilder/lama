...
const config: DocsThemeConfig = {
  ...
  docsRepositoryBase: 'https://github.com/headlessbuilder/llm.report/tree/dev/apps/doc',
  editLink: {
  ...
  footer: {
    content: (
      <div className="flex w-full flex-col items-center sm:items-start">
        ...
        <p className="mt-6 text-xs">© {new Date().getFullYear()} llm.report. All rights reserved.</p>
      </div>
    ),
  },
};
